...
const Popup = ({ close, el }) => {
    return (
      <div className="fixed top-0 left-0 w-full h-full bg-opacity-70 bg-black flex items-center justify-center">
        <div className="bg-gray-800 text-white rounded-md p-4 w-64">
          ...
          <div className="bg-gray-700 m-4 p-4 text-white">
            <img
